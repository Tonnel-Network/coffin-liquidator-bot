...
async function main(bot: Messenger) {
    ...
    const evaa: OpenedContract<Evaa> = tonClient.open(new Evaa({
        testnet: IS_TESTNET,
        customMasterAddress: POOL_CONFIG.masterAddress,
    }));
    ...
    console.log(highloadContract._address.toString())
